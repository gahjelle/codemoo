...
Each persona SHALL supply a system-prompt that encodes its character and instructs the LLM to comment briefly (one sentence) on the tool call being observed.
