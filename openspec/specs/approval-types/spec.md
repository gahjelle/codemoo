...
A module `core/bots/approval.py` SHALL export the complete approval gate
...
- **WHEN** `from codemoo.core.bots.approval import Approved, Denied, GuardDecision, ApprovalRequest` is executed
