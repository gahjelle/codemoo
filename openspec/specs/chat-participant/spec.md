...
#### Scenario: Protocol requires name and on_message
- **WHEN** an object exposes a `name: str` property and an async `on_message(message: ChatMessage) -> ChatMessage | None` method
