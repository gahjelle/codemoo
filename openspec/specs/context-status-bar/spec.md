...
Defines the `ContextStatus` widget behaviour for displaying a live summary of the current conversation context, including message count and estimated token usage.
