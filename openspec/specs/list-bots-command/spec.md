# Spec: list-bots-command

## Purpose

TBD — defines the `codemoo list-bots` subcommand that prints all available bots as a rich table and exits, without launching the TUI or making any LLM calls.
