# Spec: human-shell-mode

## Purpose

Defines the `!`-prefixed shell escape mode that allows the user to run arbitrary shell commands directly from the chat input. Shell output is displayed in a distinct bubble, copied to the clipboard, and kept out of the bot conversation context.
