# Spec: bot-spec-resolver

## Purpose

TBD — defines the `resolve_bot` function that maps a string spec (index, name, or type) to a single bot instance from an ordered list of `ChatParticipant` instances.
