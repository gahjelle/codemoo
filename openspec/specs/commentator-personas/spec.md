# Spec: commentator-personas

## Purpose

TBD — defines the ten commentator personas, their characters, and the content of their instruction files. Each persona is a named Norwegian sports commentator with a distinctive voice used by `CommentatorBot` to generate tool-call commentary.
