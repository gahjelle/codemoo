# Spec: commentator-persona-config

## Purpose

TBD — defines the configuration schema and loading pipeline for commentator personas, enabling persona definitions to be declared in `codemoo.toml` and injected into `CommentatorBot` at construction time.
