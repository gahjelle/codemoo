# Spec: demoo-agent-command

## Purpose

TBD — Defines the `demoo agent` CLI command that runs a full agentic tool loop, repeatedly calling the LLM with tool results until a plain-text reply is returned.
