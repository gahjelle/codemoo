...
- **Act 2 — Control** (Sona → T): "Instructions and tools — the two levers."
- **Act 3 — Access** (R → A): "Reading and running. Now it touches the real world."
- **Act 4 — Agency** (L → PlannerBot): "Goals, not commands. Planning, not just reacting."
